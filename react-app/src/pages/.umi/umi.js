...
import findRoute, {
  getUrlQuery,
} from '/Users/liuqiyu/Desktop/lionBridgeProject/CarLoan_assist_pc/node_modules/_umi-build-dev@1.18.5@umi-build-dev/lib/findRoute.js';
import '../../../node_modules/_umi-plugin-hd@1.7.0@umi-plugin-hd/template/index.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/_umi-plugin-ui@1.5.3@umi-plugin-ui/lib/bubble').default(
      {
        port: 3000,
        path: '/Users/liuqiyu/Desktop/lionBridgeProject/CarLoan_assist_pc',
        currentProject: '',
        isBigfish: undefined,
      },
    );
